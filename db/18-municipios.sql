...
--
--  Fonte: IBGE, API de localidades, 27 UFs e 5571 municípios.
...
INSERT INTO municipios (codigo, uf, nome) VALUES
  ...
  (3501905, 'SP', 'Amparo'),
  (2500734, 'PB', 'Amparo'),
  (2800100, 'SE', 'Amparo do São Francisco'),
  ...
  (3105509, 'MG', 'Barão do Monte Alto'),
  ...
  (5101837, 'MT', 'Boa Esperança do Norte'),
  ...
  (5107800, 'MT', 'Santo Antônio de Leverger'),
  ...
  (4126108, 'PR', 'São Tomé'),
  (2412906, 'RN', 'São Tomé'),
  (3165206, 'MG', 'São Tomé das Letras'),
